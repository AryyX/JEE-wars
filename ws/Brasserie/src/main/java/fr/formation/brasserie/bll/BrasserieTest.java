...
public class BrasserieTest {
	...
	public static void main(String[] args) throws BrasserieException {
		Brasserie br = new Brasserie(1,12345,"bretagne","oui","ouioui");
		...
		System.out.println(brasserie.ajoutBrasserie(br));
		...
		brasserie.getHistoryBrasserie().forEach(System.out::println);
